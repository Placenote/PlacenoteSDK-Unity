...
namespace UnityEngine.XR.iOS
{
	public class UnityARUtility
	{
		...
		public static GameObject UpdatePlaneWithAnchorTransform(GameObject plane, ARPlaneAnchor arPlaneAnchor)
		{
			...
			plane.transform.parent = cameraParent.transform;
			plane.transform.localPosition = UnityARMatrixOps.GetPosition (arPlaneAnchor.transform);
			plane.transform.localRotation = UnityARMatrixOps.GetRotation (arPlaneAnchor.transform);
