...
public class UnityARCameraManager : MonoBehaviour {
	...
	void Start () {
		...
		scamera.worldTransform = new UnityARMatrix4x4 (new Vector4 (1, 0, 0, 0),
		...
		scamera.projectionMatrix = new UnityARMatrix4x4 (projMat.GetColumn(0),
			projMat.GetColumn(1), projMat.GetColumn(2), projMat.GetColumn(3));
